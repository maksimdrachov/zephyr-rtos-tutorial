...
![k_thread_im]({{ site.baseurl }}/svg-images/threads/thread-start.png)

### k_thread_abort()
Abort a thread. Thread is taken off all kernel queues.

![k_thread_im]({{ site.baseurl }}/svg-images/threads/thread-abort.png)
...
![k_thread_im]({{ site.baseurl }}/svg-images/threads/thread-sleep.png)

### k_thread_suspend()
Prevent a thread from executing for an indefinite period of time. Once suspended, use k_thread_resume() to re-start.

![k_thread_im]({{ site.baseurl }}/svg-images/threads/thread-suspend.png)
...
![k_thread_im]({{ site.baseurl }}/svg-images/threads/thread-join.png)
